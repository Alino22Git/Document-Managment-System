...
namespace DMS_Tests
{
    public class DocumentTests
    {
        ...
        public void DocumentDTO_Mapping_ShouldBeValid()
        {
            ...
            var document = new DMS_DAL.Entities.Document { Id = 1, Title = "Test Document", FileType = "pdf", CreatedAt = DateTime.Now };
        ...
        {
            var document = new DMS_DAL.Entities.Document { FileType = "pdf", CreatedAt = DateTime.Now };
